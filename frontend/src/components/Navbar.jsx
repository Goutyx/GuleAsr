      ...
      >
        <div className="flex justify-between items-center max-w-[1800px] mx-auto">
          ...
          <div className="flex-1 flex justify-end items-center gap-4 md:gap-5">
            <button className="text-primary hover:text-accent transition-colors hidden sm:block" aria-label="Search">
              <Search size={20} />
            </button>
            <Link to={user ? "/profile" : "/login"} className="text-primary hover:text-accent transition-colors hidden sm:block" aria-label="Account">
              <User size={20} />
            </Link>
            
            {isAdmin && <Link to="/admin" className="text-[10px] md:text-xs uppercase tracking-widest text-secondary hover:text-primary hidden sm:block">Admin</Link>}
